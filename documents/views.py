...
def view_documents(request):
    ...
    if user.role == 'HR':
        ...
        if employee_id:
            ...
            return render(request, 'hr/hr_documents_employee.html', {'documents': documents, 'employee': employee})
        else:
            documents = Document.objects.all()
            return render(request, 'hr/hr_documents_employee.html', {'documents': documents})
