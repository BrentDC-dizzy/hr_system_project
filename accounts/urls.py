...
path('sd/employees/profile/<int:user_id>/', views.sd_employee_profile_view, name='sd_employee_profile_view'),
path('hr/employees/profile/<int:user_id>/self-upload/', views.update_employee_self_upload, name='update_employee_self_upload'),
